    ...
    <div className={`faq-item  ${show ? "active" : ""}`}>
      ...
      <div className="faq-item-body">
        <div className="faq-item-body-content">
          ...
          quo labore quibusdam obcaecati dolores vitae sit accusantium nisi rem
          eum illo mollitia, iusto atque voluptatem delectus exercitationem,
          numquam suscipit facilis aliquam? Commodi maiores ullam nulla hic
          nesciunt, voluptatum veritatis soluta!
        </div>
      </div>
    </div>
  );
